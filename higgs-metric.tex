...
In ``wildly ramified'' examples the analytic structure of the functions $\cX_\gamma(\zeta)$ 
can be even simpler: we can arrange that there are jumps along just $4$ rays,
