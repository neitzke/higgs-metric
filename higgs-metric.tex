...
which never exceeds $10^{-5}$ over the range of $R$ shown.
...
\begin{itemize}
  ...
  with $\phi_2 = 0$ and $\phi_3 = P(z) \de z^3$, for $P(z)$ of degree $2$ or $3$.
\end{itemize}
The results are qualitatively similar to those shown above.
