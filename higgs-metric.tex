...
defined \hk metric. However, this metric is not easily
written in closed form.

To construct it, one needs to consider \ti{Hitchin's equation}:
...
\begin{prop}[Existence of solutions to Hitchin equation]
The equation \eqref{eq:hitchin-equation} has a unique
adapted solution $h$ for each $(E,\varphi)$.
\end{prop}

Given the solutions of \eqref{eq:hitchin-equation}
